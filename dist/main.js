...
/* harmony export */   "readEditForm": () => (/* binding */ readEditForm),
/* harmony export */   "readForm": () => (/* binding */ readForm)
/* harmony export */ });
...
const displaySidebar = () => {
    ...
    homeLink.addEventListener('click', function () {
        (0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.displayTodos)();
    });

    //Display links to Home view and different projects
    const projectLinks = document.createElement('div');
    projectLinks.className = "projectLinks";
    let allProjects = (0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.findProjects)();
    for (const project of allProjects) {
        ...
        projectLink.addEventListener('click', function () {
            (0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.displayTodos)(project);
            (0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.updateFilter)(project);
        });
    }
...
const readForm = () => {
    ...
    (0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.addTodo)(title, desc, date, priority, project);
    (0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.displayTodos)(project);
    displaySidebar();
    form.reset();
    formError.innerHTML = "";
...
const openEditForm = (id) => {
    ...
    form.elements[0].value = _todos_js__WEBPACK_IMPORTED_MODULE_1__.allTodos[id].title;
    form.elements[1].value = _todos_js__WEBPACK_IMPORTED_MODULE_1__.allTodos[id].desc;
    form.elements[2].value = _todos_js__WEBPACK_IMPORTED_MODULE_1__.allTodos[id].dueDate;
    form.elements[3].value = _todos_js__WEBPACK_IMPORTED_MODULE_1__.allTodos[id].project;

    if (_todos_js__WEBPACK_IMPORTED_MODULE_1__.allTodos[id].priority === "Medium") {
        LowRadio.checked = false;
        MediumRadio.checked = true;
    }
    else if (_todos_js__WEBPACK_IMPORTED_MODULE_1__.allTodos[id].priority === "High") {
        LowRadio.checked = false;
...
const readEditForm = () => {
    ...
    (0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.editTodo)(currentlyEditingID, titleInput, descInput, dateInput, priorityInput, projectInput);
    (0,_todos_js__WEBPACK_IMPORTED_MODULE_1__.displayTodos)();
    displaySidebar();
    form.reset();
    formError.innerHTML = "";
...
const displayEdit = (id) => {
    ...
    edit.addEventListener('click', function (e) {
        ...
        e.stopPropagation()
        ;(0,_sidebar__WEBPACK_IMPORTED_MODULE_9__.openModal)();
        (0,_sidebar__WEBPACK_IMPORTED_MODULE_9__.openEditForm)(actualID);
    });
    ...
    //clear the DOM element
     ...
     for (const todo of allTodos) {
         ...
         if (todo.project === filter || filter === "") {
            ...
            icons.append((0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(new Date(todo.year, todo.month, todo.day), 'MMM-dd'));
