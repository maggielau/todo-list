...
const displayTodos = () => {
    //clear the DOM element
     ...
     for (const todo of allTodos) {
        ...
        icons.append((0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(new Date(todo.year, todo.month, todo.day), 'MMM-dd'));
...
modalbutton.addEventListener('click', function () {
    (0,_sidebar_js__WEBPACK_IMPORTED_MODULE_1__.readForm)();
});
